...
export namespace greeterpackage {
    ...
    export class TestReply extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            message?: string;
        }) {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): TestReply {
            const reader = bytes instanceof pb_1.BinaryReader ? bytes : new pb_1.BinaryReader(bytes), message = new TestReply();
            while (reader.nextField()) {
                if (reader.isEndGroup())
                    break;
                switch (reader.getFieldNumber()) {
        ...
        static deserializeBinary(bytes: Uint8Array): TestReply {
            return TestReply.deserialize(bytes);
        }
    }
    ...
    export abstract class UnimplementedGreeterService {
        static definition = {
            ...
            SayTest: {
                path: "/greeterpackage.Greeter/SayTest",
                requestStream: false,
                responseStream: false,
                ...
                responseSerialize: (message: TestReply) => Buffer.from(message.serialize()),
                responseDeserialize: (bytes: Buffer) => TestReply.deserialize(new Uint8Array(bytes))
            }
        };
        ...
        abstract SayTest(call: grpc_1.ServerUnaryCall<TestRequest, TestReply>, callback: grpc_1.sendUnaryData<TestReply>): void;
    }
    export class GreeterClient extends grpc_1.makeGenericClientConstructor(UnimplementedGreeterService.definition, "Greeter", {}) {
        ...
        SayTest: GrpcUnaryServiceInterface<TestRequest, TestReply> = (message: TestRequest, metadata: grpc_1.Metadata | grpc_1.CallOptions | grpc_1.requestCallback<TestReply>, options?: grpc_1.CallOptions | grpc_1.requestCallback<TestReply>, callback?: grpc_1.requestCallback<TestReply>): grpc_1.ClientUnaryCall => {
            return super.SayTest(message, metadata, options, callback);
        };
    }
}
